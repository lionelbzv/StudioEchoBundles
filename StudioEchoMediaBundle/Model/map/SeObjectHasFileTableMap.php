...
class SeObjectHasFileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.StudioEchoBundles.StudioEchoMediaBundle.Model.map.SeObjectHasFileTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('StudioEchoBundles\\StudioEchoMediaBundle\\Model\\SeObjectHasFile');
    ...
    {
        $this->addRelation('SeMediaObject', 'StudioEchoBundles\\StudioEchoMediaBundle\\Model\\SeMediaObject', RelationMap::MANY_TO_ONE, array('se_media_object_id' => 'id', ), 'CASCADE', 'CASCADE');
        $this->addRelation('SeMediaFile', 'StudioEchoBundles\\StudioEchoMediaBundle\\Model\\SeMediaFile', RelationMap::MANY_TO_ONE, array('se_media_file_id' => 'id', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
