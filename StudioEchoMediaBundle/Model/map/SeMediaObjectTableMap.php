...
class SeMediaObjectTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.StudioEchoBundles.StudioEchoMediaBundle.Model.map.SeMediaObjectTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('StudioEchoBundles\\StudioEchoMediaBundle\\Model\\SeMediaObject');
    ...
    {
        $this->addRelation('SeObjectHasFile', 'StudioEchoBundles\\StudioEchoMediaBundle\\Model\\SeObjectHasFile', RelationMap::ONE_TO_MANY, array('id' => 'se_media_object_id', ), 'CASCADE', 'CASCADE', 'SeObjectHasFiles');
        $this->addRelation('SeMediaFile', 'StudioEchoBundles\\StudioEchoMediaBundle\\Model\\SeMediaFile', RelationMap::MANY_TO_MANY, array(), 'CASCADE', 'CASCADE', 'SeMediaFiles');
    } // buildRelations()
