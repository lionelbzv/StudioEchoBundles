...
class SeMediaFileI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.StudioEchoBundles.StudioEchoMediaBundle.Model.map.SeMediaFileI18nTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('StudioEchoBundles\\StudioEchoMediaBundle\\Model\\SeMediaFileI18n');
