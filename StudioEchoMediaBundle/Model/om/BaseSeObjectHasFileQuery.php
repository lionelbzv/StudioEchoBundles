...
abstract class BaseSeObjectHasFileQuery extends ModelCriteria
{
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \StudioEchoBundles\StudioEchoMediaBundle\Model\SeMediaObjectQuery A secondary query class using the current class as primary query
     */
    public function useSeMediaObjectQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SeMediaObject', '\StudioEchoBundles\StudioEchoMediaBundle\Model\SeMediaObjectQuery');
    }
