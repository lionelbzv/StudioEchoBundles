...
namespace StudioEchoBundles\MediaBundle\PropelBehaviors;
...
class MediaBundleBehavior extends Behavior {
    ...
    {
      return "
        \$seMediaObject = new \StudioEchoBundles\MediaBundle\Model\SeMediaObject();
    ...
    {
      return "
        \$seMediaObject = \StudioEchoBundles\MediaBundle\Model\SeMediaObjectQuery::create()->filterByObjectClassname(get_class(\$this))->filterByObjectId(\$this->getId())->findOne();
