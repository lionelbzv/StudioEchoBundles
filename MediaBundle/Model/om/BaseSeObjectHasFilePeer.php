...
use StudioEchoBundles\MediaBundle\Model\map\SeObjectHasFileTableMap;
...
abstract class BaseSeObjectHasFilePeer
{
    ...
    const OM_CLASS = 'StudioEchoBundles\\MediaBundle\\Model\\SeObjectHasFile';

    /** the related TableMap class for this table */
    const TM_CLASS = 'StudioEchoBundles\\MediaBundle\\Model\\map\\SeObjectHasFileTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseSeObjectHasFilePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \StudioEchoBundles\MediaBundle\Model\map\SeObjectHasFileTableMap());
      }
    }
