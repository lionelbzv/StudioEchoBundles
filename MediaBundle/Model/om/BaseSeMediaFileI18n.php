...
use StudioEchoBundles\MediaBundle\Model\SeMediaFileI18n;
use StudioEchoBundles\MediaBundle\Model\SeMediaFileI18nPeer;
use StudioEchoBundles\MediaBundle\Model\SeMediaFileI18nQuery;
...
abstract class BaseSeMediaFileI18n extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'StudioEchoBundles\\MediaBundle\\Model\\SeMediaFileI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SeMediaFileI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseSeMediaFileI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SeMediaFileI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = SeMediaFileI18nPeer::LOCALE;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = SeMediaFileI18nPeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = SeMediaFileI18nPeer::DESCRIPTION;
        }
    ...
    public function setCopyright($v)
    {
        ...
        if ($this->copyright !== $v) {
            $this->copyright = $v;
            $this->modifiedColumns[] = SeMediaFileI18nPeer::COPYRIGHT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating SeMediaFileI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aSeMediaFile !== null && $this->id !== $this->aSeMediaFile->getId()) {
            $this->aSeMediaFile = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SeMediaFileI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SeMediaFileI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SeMediaFileI18nPeer::LOCALE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `se_media_file_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SeMediaFileI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SeMediaFileI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SeMediaFileI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SeMediaFileI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = SeMediaFileI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(SeMediaFileI18nPeer::DATABASE_NAME);
        $criteria->add(SeMediaFileI18nPeer::ID, $this->id);
        $criteria->add(SeMediaFileI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of SeMediaFileI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SeMediaFileI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SeMediaFileI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SeMediaFileI18nPeer();
        }
    ...
    {
        if ($this->aSeMediaFile === null && ($this->id !== null) && $doQuery) {
            $this->aSeMediaFile = SeMediaFileQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSeMediaFile->addSeMediaFileI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SeMediaFileI18nPeer::DEFAULT_STRING_FORMAT);
    }
