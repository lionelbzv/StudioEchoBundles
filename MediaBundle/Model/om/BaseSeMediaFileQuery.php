...
use StudioEchoBundles\MediaBundle\Model\SeMediaFilePeer;
use StudioEchoBundles\MediaBundle\Model\SeMediaFileQuery;
use StudioEchoBundles\MediaBundle\Model\SeMediaObject;
use StudioEchoBundles\MediaBundle\Model\SeObjectHasFile;
...
abstract class BaseSeMediaFileQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'StudioEchoBundles\\MediaBundle\\Model\\SeMediaFile';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \StudioEchoBundles\MediaBundle\Model\SeObjectHasFileQuery A secondary query class using the current class as primary query
     */
    public function useSeObjectHasFileQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SeObjectHasFile', '\StudioEchoBundles\MediaBundle\Model\SeObjectHasFileQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \StudioEchoBundles\MediaBundle\Model\SeMediaFileI18nQuery A secondary query class using the current class as primary query
     */
    public function useSeMediaFileI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinSeMediaFileI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SeMediaFileI18n', '\StudioEchoBundles\MediaBundle\Model\SeMediaFileI18nQuery');
    }
