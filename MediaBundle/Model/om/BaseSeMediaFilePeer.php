...
use StudioEchoBundles\MediaBundle\Model\map\SeMediaFileTableMap;
...
abstract class BaseSeMediaFilePeer
{
    ...
    const OM_CLASS = 'StudioEchoBundles\\MediaBundle\\Model\\SeMediaFile';

    /** the related TableMap class for this table */
    const TM_CLASS = 'StudioEchoBundles\\MediaBundle\\Model\\map\\SeMediaFileTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseSeMediaFilePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \StudioEchoBundles\MediaBundle\Model\map\SeMediaFileTableMap());
      }
    }
