...
use StudioEchoBundles\MediaBundle\Model\SeObjectHasFileQuery;
...
abstract class BaseSeObjectHasFileQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'StudioEchoBundles\\MediaBundle\\Model\\SeObjectHasFile';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \StudioEchoBundles\MediaBundle\Model\SeMediaObjectQuery A secondary query class using the current class as primary query
     */
    public function useSeMediaObjectQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SeMediaObject', '\StudioEchoBundles\MediaBundle\Model\SeMediaObjectQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \StudioEchoBundles\MediaBundle\Model\SeMediaFileQuery A secondary query class using the current class as primary query
     */
    public function useSeMediaFileQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SeMediaFile', '\StudioEchoBundles\MediaBundle\Model\SeMediaFileQuery');
    }
